        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1>User's Etatcivil Data</h1>
                    @if ($etatcivil)
                        <p>cin : {{ $etatcivil->cin }}</p>
                        <p>nom : {{ $etatcivil->nom_fr }}</p>
                        <p>prenom : {{ $etatcivil->prenom_fr }}</p>
                    @else
                    ...
                    <a class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500
                     hover:text-gray-700 hover:border-gray-300 focus:outline-none
                      focus:text-gray-700 focus:border-gray-300
                       transition duration-150 ease-in-out" href="{{route('etatcivils.edit',$etatcivil)}}">Modifier votre etat civil </a>
                    {{-- <div class="row">
