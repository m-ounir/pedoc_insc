            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('etatcivils.store')}}">
                        ...
                        <label class="block font-medium text-sm text-gray-700" for="lieu_nais_ar">Lieu de naissance ar: </label>
                        ...
                        <label class="block font-medium text-sm text-gray-700" for="pays_nais">Pays naissance : </label> 
                        ...
                        <label class="block font-medium text-sm text-gray-700" for="sexe">Sexe : </label>
                        ...
                        <label class="block font-medium text-sm text-gray-700" for="situation_f">Situation familiale : </label>
                        ...
                        focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150" href="{{route('dashboard')}}">Précédent </a>

                        <button class="inline-flex items-center px-4 py-2 bg-green-800 border border-transparent rounded-md 
                            font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700
                            active:bg-gray-900 focus:outline-none focus:ring-2
                            focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150" type="submit">Suivant </button>
                    </form>
