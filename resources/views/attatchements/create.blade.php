        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 justify-center row">
                    <form method="POST" action="{{ route('attatchements.store')}}" enctype="multipart/form-data" class="justify-content-center col-md-6 text-center">
                       ...
                       <div class="mt-5">
                            <a class="btn btn-outline-info" href="{{route('bac5s.index')}}">Précédent </a>
