        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 justify-center row">
                    <form method="POST" action="{{ route('attatchements.update' ,$encodedData)}}" class="justify-content-center col-md-6 text-center">
                        ...
                        <input class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm " type="file" name="cin"  value="{{$encodedData->cin}}" />
                        
                        <label class="block font-medium text-sm text-gray-700 mt-2" for="cv">Fichier CV (pdf) :  </label>
                        <input class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm " type="file" name="cv" value="{{$encodedData->cv}}"  />
                        
                        <label class="block font-medium text-sm text-gray-700 mt-2" for="bac">Fichier BAC (pdf) :  </label>
                        <input class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm " type="file" name="bac" value="{{$encodedData->bac}}" />
                        
                        <label class="block font-medium text-sm text-gray-700 mt-2" for="bac3">Fichier BAC + 3 (pdf) :  </label>
                        <input class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm " type="file" name="bac3" value="{{$encodedData->bac3}}" />
                        
                        <label class="block font-medium text-sm text-gray-700 mt-2" for="note_bac3">Fichier relevées des notes de S1 à S6 (pdf) :  </label>
                        <input class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm " type="file" name="note_bac3" value="{{$encodedData->note_bac3}}" />
                        
                        <label class="block font-medium text-sm text-gray-700 mt-2" for="bac5">Fichier BAC + 5 (pdf) :  </label>
                        <input class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm " type="file" name="bac5" value="{{$encodedData->bac5}}"  />

                        <label class="block font-medium text-sm text-gray-700 mt-2" for="note_bac5">Fichier relevées des notes de S7 à S10 (pdf) : </label>
                        <input class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm " type="file" name="note_bac5"  value="{{$encodedData->note_bac5}}"/>
