<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Remplire les info baccalauréat') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 justify-center row">
                    <form method="POST" action="{{ route('bacs.store')}}" class="justify-content-center col-md-6 text-center">
                        ...
                        <label class="block font-medium text-sm text-gray-700 mt-3" for="annee_bac">Date d'obtention :  </label>
                        ...
                        <select name="type_bac" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm ">
                        ...
                        <label class="block font-medium text-sm text-gray-700 mt-3" for="moyen">Moyenne : </label>
...
{{-- 
                       ...
                       <a class="btn btn-outline-info" href="{{route('etatcivils.index')}}">Précédent </a>
